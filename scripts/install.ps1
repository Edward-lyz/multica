...
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.ps1 | iex
#
...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/Edward-lyz/multica.git"
$RepoWebUrl    = "https://github.com/Edward-lyz/multica"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/Edward-lyz/multica/releases/latest" -ErrorAction Stop
...
function Start-DefaultInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="with-server"; irm https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
