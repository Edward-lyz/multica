...
#   curl -fsSL https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.sh | bash
#
# Install CLI + provision self-host server:
#   curl -fsSL https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.sh | bash -s -- --with-server
#
...
# Configuration
# ---------------------------------------------------------------------------
REPO_URL="https://github.com/Edward-lyz/multica.git"
REPO_WEB_URL="https://github.com/Edward-lyz/multica"  # without .git, for GitHub web APIs
...
print_remote_server_token_hint() {
  ...
  printf "     1. On your local computer, open ${CYAN}https://multica.n.baidu-int.com/settings?tab=tokens${RESET}\n"
...
detect_os() {
  ...
  irm https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.ps1 | iex" ;;
...
run_default() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.sh | bash -s -- --with-server\n"
  printf "\n"
}
...
run_with_server() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/Edward-lyz/multica/main/scripts/install.sh | bash -s -- --stop\n"
  printf "\n"
}
